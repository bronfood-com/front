...
import { Restaurant, RestaurantWithoutMeals } from '../../utils/api/restaurantsService/restaurantsService';

export const mockRestaurantsNew: RestaurantWithoutMeals[] = [
    {
        id: 1,
        photo: restaurant3,
        name: 'Jahu',
        rating: 4.8,
        address: 'ул. Березовая 23',
        coordinates: {
...
export const mockOneRestaurant: Restaurant = {
    id: '1',
    photo: restaurant3,
    name: 'Jahu',
    rating: 4.8,
